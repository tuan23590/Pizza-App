...
export default function ChiTietDonHang({ openDialog, handleCloseDialog, selectedOrder }) {
                ...
                {selectedOrder && (
                    <Grid container>
                        <Grid item sm={6}>
                            ...
                            <Grid item sm={12}>
                            <Typography variant='h5' mb={1} ><b>Thông tin đơn hàng:</b></Typography>
                            </Grid>
                                <Grid item sm={12}>
                                    <Typography><b>Mã đơn hàng:</b> {selectedOrder.maDonHang}</Typography>
                                </Grid>
                                <Grid item sm={12}>
                        ...
                        <Grid item sm={6}  >
                            <Typography variant='h5' ><b>Danh sách sản phẩm:</b></Typography>
    ...
    <Typography fullWidth textAlign={'start'}>
        <b>Tạm tính:</b>
        <span style={{ textAlign: 'end', display: 'inline-block', width: '160px' }}>
    ...
    <Typography fullWidth textAlign={'start'} color={'green'}>
        <b>Tổng tiền: </b>
        <span style={{ fontSize: '25px', textAlign: 'end', display: 'inline-block', width: '160px' }}>
