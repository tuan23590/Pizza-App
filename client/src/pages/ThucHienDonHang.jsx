                    ...
                    >
                      ...
                      >
                        ...
                        <Typography
                          sx={{
                            backgroundColor:
                              (15 - parseInt((Date.now() - donHang.trangThai[donHang.trangThai?.length - 1].thoiGian) / 1000 / 60)) < 0 ? "#ff1744" : "#4caf50", // Màu đỏ nếu trễ, xanh lá nếu còn thời gian
                            borderRadius: 2,
                            color: "white",
                            fontWeight: "600",
                            paddingX: "5px",
                        ...
                        >
                          {(15 - parseInt((Date.now() - donHang.trangThai[donHang.trangThai?.length - 1].thoiGian) / 1000 / 60)) < 0
                            ? `Trễ ${Math.abs(15 - parseInt((Date.now() - donHang.trangThai[donHang.trangThai?.length - 1].thoiGian) / 1000 / 60))} phút` // Hiển thị số phút trễ
                            : `Hoàn thành ${15 - parseInt((Date.now() - donHang.trangThai[donHang.trangThai?.length - 1].thoiGian) / 1000 / 60)} phút`}{" "}
                        </Typography>
